          ...
          if (isSpeakingRef.current) {
            ...
            setTimeout(() => {
              if (!state.isListening && recognitionRef.current) {
                if (!state.hasGreeted) {
                  speakOut('Hello, This is state bank of india. How may I help you?', () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-4 md:left-5 z-30">
        <img src={img} alt="JPMC Logo" className="jpmc-logo w-20 md:w-20 mt-4 filter invert brightness-0" />
      </div>
